...
PNODE findDeepestNodeInTree(PNODE Head)
{
	queue<PNODE> Q;
...
int main()
{
	...
	PNODE pRet = findDeepestNodeInTree(First);
	cout<<"Deepest Node data of tree is : "<<pRet -> data<<endl;
	cout<<"Deepest Node add of tree is : "<<pRet<<endl;
